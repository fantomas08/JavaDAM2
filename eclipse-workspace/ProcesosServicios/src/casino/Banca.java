...
public class Banca {
	...
	public void simular(int jugadoresPar, int jugadoresMartingala,
			int jugadoresClasicos, int jugadoresRojoNegro) throws InterruptedException{
		...
		Thread[] hilosJugadoresRojoNegro=new Thread[jugadoresRojoNegro];
		for (int i=0; i<jugadoresRojoNegro; i++) {
			JugadorRojoNegro jugador=new JugadorRojoNegro(1000, this);
			hilosJugadoresRojoNegro[i]=new Thread ( jugador );
			hilosJugadoresRojoNegro[i].setName("Apostador rojo/negro "+i);
			hilosJugadoresRojoNegro[i].start();
		}
